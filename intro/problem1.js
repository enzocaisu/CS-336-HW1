...
function draw(shiftValue, scaleValue)
{
  ...
  let angle  = gl.getUniformLocation(shader, "angle");
  gl.uniform1f(angle, shiftValue);

  let scale = gl.getUniformLocation(shader, "scale");
